    ...
    return <section id="terapia" className="align-items-center">
        ...
        <div className='container'>
            <div className='d-flex justify-content-center align-items-center' >
                {
                    !showVideo ? <CallToActionButton event={'abriu_video_terapia'} redirect={false}>
                        <div onClick={() => setShowVideo(!showVideo)} style={{ position: "relative", maxWidth: '800px' }}>
                            <img
                    ...
                    </CallToActionButton> : <iframe width="560" height="315" src="https://www.youtube.com/embed/ROureOTjP_s?autoplay=1" title="Como funciona a terapia" frameborder="0" allow=" autoplay; encrypted-media; gyroscope;" allowfullscreen></iframe>
